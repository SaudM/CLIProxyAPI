...
func TestClaudeBodyNeedsBillingFallbackTracksSystemPresence(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			body: `{"system":[{"type":"text","text":"x-anthropic-billing-header: cc_version=2.1.274; cc_entrypoint=cli; cch=00000;"}]}`,
			want: true,
		},
		{
...
// A 2.1.274 helper that reaches CPA through ANTHROPIC_BASE_URL carries no
