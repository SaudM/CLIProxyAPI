...
var zhStrings = map[string]string{
	...
	"auth_help2":      " [1] 编辑 prefix • [2] 编辑 proxy_url • [3] 编辑 priority • [4] RPM • [5] TPM • [6] 最大并发",
	"no_auth_files":   "  无认证文件",
	...
	"usage_rpm":              "RPM",
	"usage_tpm":              "TPM",
	"auth_fingerprint_mode":  "出站身份",
	"auth_fingerprint_ua":    "出站 UA",
	"auth_fingerprint_proxy": "出站代理",
...
var enStrings = map[string]string{
	...
	"auth_help2":      " [1] Edit prefix • [2] Edit proxy_url • [3] Edit priority • [4] RPM • [5] TPM • [6] Max concurrent",
	...
	"usage_rpm":              "RPM",
	"usage_tpm":              "TPM",
	"auth_fingerprint_mode":  "Identity",
	"auth_fingerprint_ua":    "Upstream UA",
	"auth_fingerprint_proxy": "Upstream Proxy",
